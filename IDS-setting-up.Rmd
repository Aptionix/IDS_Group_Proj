...
```{r}
write.csv(gdp_per_capita_df, "/Users/charliedicker/Documents/Uni/Year 1/R basics (data science)/Coursework/Exported data/gdp_per_capita_df.csv", row.names = FALSE)
write.csv(youth_not_in_eet, "/Users/charliedicker/Documents/Uni/Year 1/R basics (data science)/Coursework/Exported data/youth_not_in_eet.csv", row.names = FALSE)
